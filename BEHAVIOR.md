...
- should call toggleRepoInProject when a project is clicked
- should open unified projects dialog when clicked
- should render projects in dialog when they exist
- should render trigger button
