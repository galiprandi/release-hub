...
- **Hardening**: Middleware `spawn` con `shell: false`. Allow-list estricto en `/local/exec`. SSRF protection bloqueando 127.0.0.0/8, 169.254.0.0/16, CGNAT y IPv6 local. Sanitización de inputs para CLI.
