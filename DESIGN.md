...
- **SSRF Protection**: El handler `health-proxy` implementa una denegación estricta de solicitudes dirigidas a direcciones IP de loopback, redes privadas (RFC 1918), link-local (169.254.169.254) y dominios internos para prevenir ataques de Server-Side Request Forgery en el entorno de desarrollo.
