		...
		<Tooltip.Root>
				<Tooltip.Trigger asChild>
					<button
						...
						onClick={onClick}
						disabled={isDisabled}
						className={`${sizeClass} ${colorClass} rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:outline-none focus-visible:ring-offset-1 ${showLabel ? 'inline-flex items-center gap-1.5 px-2.5 py-1.5' : ''} ${className}`}
