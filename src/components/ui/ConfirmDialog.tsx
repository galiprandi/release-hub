			...
			<div className="flex flex-col flex-1 overflow-y-auto">
				...
				<div className="mt-6 pt-4 border-t flex justify-end gap-2 flex-shrink-0">
					<button
						...
						disabled={disabled}
						className="px-4 py-2 text-xs font-medium border rounded-lg hover:bg-accent transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-1 focus-visible:outline-none"
					>
						{cancelText}
					</button>
					<button
						...
						disabled={disabled}
						className={`px-4 py-2 text-xs font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:ring-offset-1 focus-visible:outline-none ${config.buttonClass}`}
					>
						{isLoading ? (
							<>
