		...
		<Tooltip.Root delayDuration={0}>
			<Tooltip.Trigger asChild>
				<Dialog.Close asChild>
					<button
						type="button"
						className={`rounded-lg opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-primary/30 focus-visible:outline-none focus-visible:ring-offset-1 ${className}`}
					>
						<X className="w-4 h-4" />
