	...
	return (
		<PageLayout
			...
			actions={[
				...
				<div key="sep-1" className="w-px h-4 bg-border/20 mx-0.5" />,
				...
				<div key="sep-2" className="w-px h-4 bg-border/20 mx-0.5" />,
				<ProjectSelector key="project-selector" repo={fullProduct} />
			]}
		...
		>
			...
			<div className="flex items-center gap-4">
				<IndustrialTabs
					options={[
						{ id: "commits", label: <div className="flex items-center gap-2"><GitCommit className="w-3 h-3" /><span>Commits</span></div> },
						{ id: "tags", label: <div className="flex items-center gap-2"><Tag className="w-3 h-3" /><span>Tags</span></div> },
					]}
					activeId={viewMode}
